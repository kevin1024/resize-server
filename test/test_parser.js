...
describe("parser", () => {
  it("parses a fit-in url with png filter", () => {
    ...
    expect(parsed).toInclude({
      ...
      filters: "format(png)",
      image: "u.realgeeks.media/hawaiis/hawaiirealestatecompany.png",
    })
  })
  it("parses a fit-in url with trim", () => {
    ...
    expect(parsed).toInclude({
      ...
      image: "5300bd6bc2133fa6cf5a-f08d3bc3583f298527886c37bf1e72be.r38.cf1.rackcdn.com/1/4dc0576c99ab13bfcde4143ffcbf12c2.jpg",
